package com.zundrel.moneyworks.capabilities;
...
import com.zundrel.moneyworks.network.MessageSyncAccount;
...
public class AccountCapability implements ICapabilitySerializable<NBTTagCompound> {
	...
	public boolean hasCapability(Capability<?> capability, EnumFacing facing) {
		return Moneyworks.ACCOUNT_DATA != null && capability == Moneyworks.ACCOUNT_DATA;
	}

	@Override
	public <T> T getCapability(Capability<T> capability, EnumFacing facing) {
		return Moneyworks.ACCOUNT_DATA != null && capability == Moneyworks.ACCOUNT_DATA ? (T) this : null;
	}
